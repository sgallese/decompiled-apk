...
public final class RealCall implements Call {
    ...
    public final class AsyncCall implements Runnable {
        ...
        public final void reuseCallsPerHostFrom(AsyncCall asyncCall) {
            q.i(asyncCall, TaskSetupFragment.TYPE_OTHER);
        ...
        public void run() {
            ...
            String q10 = q.q("OkHttp ", this.this$0.redactedUrl$okhttp());
                ...
                try {
                    try {
                        ...
                        try {
                            ...
                            e10 = e11;
                            if (z10) {
                                Platform.Companion.get().log(q.q("Callback failure for ", realCall.toLoggableString()), 4, e10);
                            } else {
                            ...
                            realCall.cancel();
                            if (!z10) {
                                IOException iOException = new IOException(q.q("canceled due to ", th));
                                b.a(iOException, th);
    ...
    /* JADX WARN: Type inference failed for: r2v3, types: [okio.a1, okhttp3.internal.connection.RealCall$timeout$1] */
    ...
    public final void enterNetworkInterceptorExchange(Request request, boolean z10) {
        ...
        if (z11) {
            synchronized (this) {
                if ((!this.responseBodyOpen) != false) {
                    if ((!this.requestBodyOpen) != false) {
                        w wVar = w.f13270a;
                    } else {
                        throw new IllegalStateException("Check failed.".toString());
                    }
    ...
    */
    public final <E extends java.io.IOException> E messageDone$okhttp(okhttp3.internal.connection.Exchange r2, boolean r3, boolean r4, E r5) {
        ...
        L41:
            r3 = 0
        L42:
            dc.w r4 = dc.w.f13270a     // Catch: java.lang.Throwable -> L17
            monitor-exit(r1)
            if (r2 == 0) goto L52
            r2 = 0
            r1.exchange = r2
    ...
    public final void timeoutEarlyExit() {
        if ((!this.timeoutEarlyExit) != false) {
