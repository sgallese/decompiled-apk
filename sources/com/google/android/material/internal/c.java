...
public class c {
    ...
    private static final ThreadLocal<Matrix> f10138a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<RectF> f10139b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f10138a;
        ...
        ThreadLocal<RectF> threadLocal2 = f10139b;
