...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private final Map zzb = DesugarCollections.synchronizedMap(new a());
    private int zzc = 0;
    private Bundle zzd;

    public static zzd zzc(q qVar) {
        zzd zzdVar;
        ...
        try {
            zzd zzdVar2 = (zzd) qVar.getSupportFragmentManager().j0("SupportLifecycleFragmentImpl");
            if (zzdVar2 == null || zzdVar2.isRemoving()) {
                zzdVar2 = new zzd();
                qVar.getSupportFragmentManager().q().e(zzdVar2, "SupportLifecycleFragmentImpl").k();
            }
