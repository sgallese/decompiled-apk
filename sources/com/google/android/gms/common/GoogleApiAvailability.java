...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    final void zae(Context context, int i10, String str, PendingIntent pendingIntent) {
        ...
        if (i10 == 18) {
            ...
            m.e z10 = new m.e(context).t(true).g(true).m(zaf).z(new m.c().h(zae));
            if (DeviceProperties.isWearable(context)) {
                ...
                z10.x(17301642).A(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker)).D(System.currentTimeMillis()).k(pendingIntent).l(zae);
            }
            if (PlatformVersion.isAtLeastO()) {
                ...
                if (str2 == null) {
                    ...
                    if (notificationChannel == null) {
                        notificationManager.createNotificationChannel(j.a("com.google.android.gms.availability", zab2, 4));
                    } else {
