...
public final class zzam extends zzax {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzam(zzaw zzawVar, Context context, zzq zzqVar, String str, zzbof zzbofVar) {
        this.zze = zzawVar;
        this.zza = context;
        this.zzb = zzqVar;
        this.zzc = str;
    ...
    public final /* bridge */ /* synthetic */ Object zzb(zzce zzceVar) throws RemoteException {
        return zzceVar.zze(ObjectWrapper.wrap(this.zza), this.zzb, this.zzc, this.zzd, 233012000);
    }
