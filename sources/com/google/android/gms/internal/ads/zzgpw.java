...
final class zzgpw extends zzgps implements RandomAccess, zzgth {
    private static final zzgpw zza = new zzgpw(new boolean[0], 0, false);
    private boolean[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzgsa.zzd;
        collection.getClass();
        if (!(collection instanceof zzgpw)) {
            return super.addAll(collection);
        }
        zzgpw zzgpwVar = (zzgpw) collection;
        int i10 = zzgpwVar.zzc;
        if (i10 == 0) {
            return false;
        }
        int i11 = this.zzc;
        if (Integer.MAX_VALUE - i11 >= i10) {
            ...
            System.arraycopy(zzgpwVar.zzb, 0, this.zzb, this.zzc, zzgpwVar.zzc);
            this.zzc = i12;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzgpwVar.zzc) {
            return false;
        }
        boolean[] zArr = zzgpwVar.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < this.zzc; i11++) {
            i10 = (i10 * 31) + zzgsa.zza(this.zzb[i11]);
        }
        return i10;
    }
    ...
    public final /* bridge */ /* synthetic */ zzgrz zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzgpw(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzgpw(boolean[] zArr, int i10, boolean z10) {
        super(z10);
        this.zzb = zArr;
        this.zzc = i10;
    }
