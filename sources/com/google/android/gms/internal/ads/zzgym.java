...
public final class zzgym {
    public static final zzgym zza = new zzgym(1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzgym zzb = new zzgym(0.0d, 1.0d, -1.0d, 0.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzgym zzc = new zzgym(-1.0d, 0.0d, 0.0d, -1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzgym zzd = new zzgym(0.0d, -1.0d, 1.0d, 0.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    ...
    public zzgym(double d10, double d11, double d12, double d13, double d14, double d15, double d16, double d17, double d18) {
        this.zze = d14;
        this.zzf = d15;
        this.zzg = d16;
        this.zzh = d10;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || zzgym.class != obj.getClass()) {
            return false;
        }
        zzgym zzgymVar = (zzgym) obj;
        if (Double.compare(zzgymVar.zzh, this.zzh) == 0 && Double.compare(zzgymVar.zzi, this.zzi) == 0 && Double.compare(zzgymVar.zzj, this.zzj) == 0 && Double.compare(zzgymVar.zzk, this.zzk) == 0 && Double.compare(zzgymVar.zzl, this.zzl) == 0 && Double.compare(zzgymVar.zzm, this.zzm) == 0 && Double.compare(zzgymVar.zze, this.zze) == 0 && Double.compare(zzgymVar.zzf, this.zzf) == 0 && Double.compare(zzgymVar.zzg, this.zzg) == 0) {
            return true;
        }
        return false;
    }
