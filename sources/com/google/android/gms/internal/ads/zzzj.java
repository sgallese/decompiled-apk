...
final class zzzj implements Choreographer.FrameCallback, Handler.Callback {
    private static final zzzj zzb = new zzzj();
    ...
    public final boolean handleMessage(Message message) {
        ...
        try {
            ...
            zzes.zzg("VideoFrameReleaseHelper", "Vsync sampling disabled due to platform error", e10);
        }
        return true;
    }
