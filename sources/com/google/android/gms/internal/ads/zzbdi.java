...
public final class zzbdi {
    ...
    public static final zzbcw zzj = zzbcw.zzd("gads:persist_flags_on_bg_thread", true);
    public static final zzbcw zzk = zzbcw.zzd("gads:query_info_bg_thread", true);
    public static final zzbcw zzl = zzbcw.zzd("gads:rewarded_load_bg_thread", true);
}
