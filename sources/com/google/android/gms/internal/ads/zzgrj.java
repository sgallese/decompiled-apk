...
final class zzgrj extends zzgps implements RandomAccess, zzgth {
    private static final zzgrj zza = new zzgrj(new float[0], 0, false);
    private float[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzgsa.zzd;
        collection.getClass();
        if (!(collection instanceof zzgrj)) {
            return super.addAll(collection);
        }
        zzgrj zzgrjVar = (zzgrj) collection;
        int i10 = zzgrjVar.zzc;
        if (i10 == 0) {
            return false;
        }
        int i11 = this.zzc;
        if (Integer.MAX_VALUE - i11 >= i10) {
            ...
            System.arraycopy(zzgrjVar.zzb, 0, this.zzb, this.zzc, zzgrjVar.zzc);
            this.zzc = i12;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof zzgrj)) {
            return super.equals(obj);
        }
        zzgrj zzgrjVar = (zzgrj) obj;
        if (this.zzc != zzgrjVar.zzc) {
            return false;
        }
        float[] fArr = zzgrjVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgrz zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzgrj(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzgrj(float[] fArr, int i10, boolean z10) {
        super(z10);
        this.zzb = fArr;
        this.zzc = i10;
    }
