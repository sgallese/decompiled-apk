...
interface zzgtl {
    ...
    @Deprecated
    void zzC(List list, zzgtt zzgttVar, zzgrc zzgrcVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgtt zzgttVar, zzgrc zzgrcVar) throws IOException;
    ...
    zzgqi zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzgtt zzgttVar, zzgrc zzgrcVar) throws IOException;

    void zzu(Object obj, zzgtt zzgttVar, zzgrc zzgrcVar) throws IOException;
