...
public final class zzakv {
    public static X509Certificate[][] zza(String str) throws zzaks, SecurityException, IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, "r");
        try {
            Pair zzc = zzakw.zzc(randomAccessFile);
            if (zzc != null) {
                ...
                long zza = zzakw.zza(byteBuffer);
                if (zza < longValue) {
                    if (zzakw.zzb(byteBuffer) + zza == longValue) {
                        if (zza >= 32) {
                            ...
                            if (allocate.getLong(8) == 2334950737559900225L && allocate.getLong(16) == 3617552046287187010L) {
                                ...
                                if (j11 >= allocate.capacity() && j11 <= 2147483639) {
                                    ...
                                    if (j12 >= 0) {
                                                                    ...
                                                                    if (j14 >= 4 && j14 <= 2147483647L) {
                                                                        ...
                                                                        if (i12 <= slice.remaining()) {
                                                                            if (slice.getInt() == 1896449818) {
                                                                                X509Certificate[][] zzl = zzl(randomAccessFile.getChannel(), new zzakr(zze(slice, i12 - 4), longValue2, zza, longValue, byteBuffer, null));
                                                                                randomAccessFile.close();
                                                                                return zzl;
                                                                            }
                                                                            slice.position(position2);
                                                                        } else {
                                                                            throw new zzaks("APK Signing Block entry #" + i10 + " size out of range: " + i12 + ", available: " + slice.remaining());
                                                                        }
                                                                    } else {
                                                                        throw new zzaks("APK Signing Block entry #" + i10 + " size out of range: " + j14);
                                                                    }
                                                                } else {
                                                                    throw new zzaks("Insufficient data to read size of APK Signing Block entry #" + i10);
                                                                }
                                                            }
                                        ...
                                        throw new zzaks("APK Signing Block sizes in header and footer do not match: " + j13 + " vs " + j11);
                                    }
                                    throw new zzaks("APK Signing Block offset out of range: " + j12);
                                }
                                throw new zzaks("APK Signing Block size out of range: " + j11);
                            }
                            throw new zzaks("No APK Signing Block before ZIP Central Directory");
                        }
                        throw new zzaks("APK too small for APK Signing Block. ZIP Central Directory offset: " + zza);
                    }
                    throw new zzaks("ZIP Central Directory is not immediately followed by End of Central Directory");
                }
                throw new zzaks("ZIP Central Directory offset out of range: " + zza + ". ZIP End of Central Directory offset: " + longValue);
            }
            throw new zzaks("Not an APK file: ZIP End of Central Directory record not found in file with " + randomAccessFile.length() + " bytes");
        } finally {
            try {
                randomAccessFile.close();
    ...
    private static void zzh(Map map, FileChannel fileChannel, long j10, long j11, long j12, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            zzakp zzakpVar = new zzakp(fileChannel, 0L, j10);
            zzakp zzakpVar2 = new zzakp(fileChannel, j11, j12 - j11);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            zzakw.zzd(duplicate, j10);
            zzakn zzaknVar = new zzakn(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] zzk = zzk(iArr, new zzako[]{zzakpVar, zzakpVar2, zzaknVar});
    ...
    */
    private static java.security.cert.X509Certificate[] zzj(java.nio.ByteBuffer r22, java.util.Map r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzakv.zzj(java.nio.ByteBuffer, java.util.Map, java.security.cert.CertificateFactory):java.security.cert.X509Certificate[]");
    }

    private static byte[][] zzk(int[] iArr, zzako[] zzakoVarArr) throws DigestException {
        long j10;
        int i10;
        int length;
        int i11 = 0;
        ...
        while (true) {
            ...
            j12 += (zzakoVarArr[i12].zza() + 1048575) / 1048576;
            i12++;
        }
        if (j12 < 2097151) {
            ...
            for (i10 = 3; i16 < i10; i10 = 3) {
                zzako zzakoVar = zzakoVarArr[i16];
                long j13 = j11;
                long zza = zzakoVar.zza();
                while (zza > j11) {
                    ...
                    long j14 = j13;
                    try {
                        zzakoVar.zzb(messageDigestArr, j14, min);
                        byte[] bArr4 = bArr3;
                        int i19 = 0;
                        while (i19 < iArr.length) {
                            int i20 = iArr[i19];
                            zzako zzakoVar2 = zzakoVar;
                            byte[] bArr5 = bArr[i19];
                            int zzb = zzb(i20);
                            int i21 = length;
    ...
    private static X509Certificate[][] zzl(FileChannel fileChannel, zzakr zzakrVar) throws SecurityException {
