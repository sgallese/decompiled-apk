...
public class zzdd {
    ...
    public final zzfud zzo;
    public final int zzp;
    public final zzfud zzq;
    public final int zzr;
    public final int zzs;
    public final int zzt;
    public final zzfud zzu;
    public final int zzv;
    public final zzfud zzw;
    ...
    public zzdd(zzdc zzdcVar) {
        ...
        z10 = zzdcVar.zzg;
        this.zzn = z10;
        zzfudVar = zzdcVar.zzh;
        this.zzo = zzfudVar;
        this.zzp = 0;
        zzfudVar2 = zzdcVar.zzi;
        this.zzq = zzfudVar2;
        this.zzr = 0;
        this.zzs = Integer.MAX_VALUE;
        this.zzt = Integer.MAX_VALUE;
        zzfudVar3 = zzdcVar.zzl;
        this.zzu = zzfudVar3;
        this.zzv = 0;
        zzfudVar4 = zzdcVar.zzm;
        this.zzw = zzfudVar4;
        i12 = zzdcVar.zzn;
        this.zzx = i12;
        this.zzy = 0;
        ...
        this.zzB = false;
        hashMap = zzdcVar.zzo;
        this.zzC = zzfug.zzc(hashMap);
        hashSet = zzdcVar.zzp;
        this.zzD = zzfui.zzl(hashSet);
    }
