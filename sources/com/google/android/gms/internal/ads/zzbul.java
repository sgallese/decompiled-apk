...
public final class zzbul extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzbul> CREATOR = new zzbum();
    ...
    public zzbul(@SafeParcelable.Param(id = 2) ParcelFileDescriptor parcelFileDescriptor) {
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        if (this.zza == null) {
            ...
            try {
                ...
                try {
                    zzcan.zza.execute(new Runnable() { // from class: com.google.android.gms.internal.ads.zzbuk
                        @Override // java.lang.Runnable
                        public final void run() {
                            DataOutputStream dataOutputStream;
                            OutputStream outputStream = autoCloseOutputStream;
                            byte[] bArr = marshall;
                            Parcelable.Creator<zzbul> creator = zzbul.CREATOR;
                            ...
                            try {
                                ...
                                zzcaa.zzh("Error transporting the ad response", e);
        ...
        if (this.zzc) {
            ...
            try {
                try {
                    ...
                    zzcaa.zzh("Could not read from parcel file descriptor", e10);
                    IOUtils.closeQuietly(dataInputStream);
                    return null;
                }
            } catch (Throwable th2) {
