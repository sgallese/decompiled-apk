...
public final class zzbm extends zzbp {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzbm(byte[] bArr, int i10, int i11) {
        super(null);
    ...
    public final void zzb(byte b10) throws IOException {
        try {
            ...
            throw new zzbn(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zze), Integer.valueOf(this.zzd), 1), e10);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i10, int i11) throws IOException {
        try {
            ...
            throw new zzbn(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(i11)), e10);
        }
    }
    ...
    @Override // com.google.android.gms.internal.wearable.zzbp
    public final void zze(int i10, zzbh zzbhVar) throws IOException {
        zzq((i10 << 3) | 2);
        zzq(zzbhVar.zzd());
        zzbhVar.zzi(this);
    }
    ...
    public final void zzn(String str) throws IOException {
        int i10 = this.zze;
        try {
            int zzx = zzbp.zzx(str.length() * 3);
            int zzx2 = zzbp.zzx(str.length());
            if (zzx2 == zzx) {
                int i11 = i10 + zzx2;
                this.zze = i11;
                int zzb = zzfe.zzb(str, this.zzc, i11, this.zzd - i11);
                this.zze = i10;
                zzq((zzb - i10) - zzx2);
                this.zze = zzb;
                return;
            ...
            byte[] bArr = this.zzc;
            int i12 = this.zze;
            this.zze = zzfe.zzb(str, bArr, i12, this.zzd - i12);
        } catch (zzfd e10) {
            this.zze = i10;
            zzB(str, e10);
    ...
    public final void zzs(long j10) throws IOException {
        ...
        if (z10 && this.zzd - this.zze >= 10) {
            while ((j10 & (-128)) != 0) {
                ...
                int i10 = this.zze;
                this.zze = i10 + 1;
                zzez.zzn(bArr, i10, (byte) ((((int) j10) & 127) | 128));
                j10 >>>= 7;
            }
            byte[] bArr2 = this.zzc;
            int i11 = this.zze;
            this.zze = i11 + 1;
            zzez.zzn(bArr2, i11, (byte) j10);
            return;
        }
        while ((j10 & (-128)) != 0) {
            try {
