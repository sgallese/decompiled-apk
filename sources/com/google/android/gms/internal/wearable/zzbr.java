...
final class zzbr extends zzas implements RandomAccess, zzdu {
    ...
    public final /* bridge */ /* synthetic */ zzcn zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzbr(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzbr(double[] dArr, int i10, boolean z10) {
        super(z10);
        this.zzb = dArr;
        this.zzc = i10;
    }
