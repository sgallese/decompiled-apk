...
public final class zzbf extends zzbi {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzbf(byte[] bArr, int i10, int i11) {
        super(null);
    ...
    public final void zzb(byte b10) throws IOException {
        try {
            ...
            throw new zzbg(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zze), Integer.valueOf(this.zzd), 1), e10);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i10, int i11) throws IOException {
        try {
            ...
            throw new zzbg(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(i11)), e10);
        }
    }
    ...
    @Override // com.google.android.gms.internal.play_billing.zzbi
    public final void zze(int i10, zzba zzbaVar) throws IOException {
        zzq((i10 << 3) | 2);
        zzq(zzbaVar.zzd());
        zzbaVar.zzh(this);
    }
    ...
    public final void zzs(long j10) throws IOException {
        ...
        if (z10 && this.zzd - this.zze >= 10) {
            while ((j10 & (-128)) != 0) {
                ...
                int i10 = this.zze;
                this.zze = i10 + 1;
                zzeq.zzn(bArr, i10, (byte) ((((int) j10) & 127) | 128));
                j10 >>>= 7;
            }
            byte[] bArr2 = this.zzc;
            int i11 = this.zze;
            this.zze = i11 + 1;
            zzeq.zzn(bArr2, i11, (byte) j10);
            return;
        }
        while ((j10 & (-128)) != 0) {
            try {
