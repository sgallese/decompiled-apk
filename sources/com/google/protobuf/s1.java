...
interface s1 {
    ...
    <K, V> void C(int i10, j0.a<K, V> aVar, Map<K, V> map) throws IOException;
    ...
    void O(int i10, List<h> list) throws IOException;

    void a(int i10, List<?> list, f1 f1Var) throws IOException;

    @Deprecated
    void b(int i10, List<?> list, f1 f1Var) throws IOException;
    ...
    void j(int i10, Object obj, f1 f1Var) throws IOException;
    ...
    @Deprecated
    void s(int i10, Object obj, f1 f1Var) throws IOException;
    ...
    void v(int i10, h hVar) throws IOException;
