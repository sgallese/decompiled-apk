...
final class AboutFragment$doTheThing$1 extends qc.r implements pc.l<Drawable, dc.w> {
    final /* synthetic */ AboutFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AboutFragment$doTheThing$1(AboutFragment aboutFragment) {
        super(1);
    ...
    public final void invoke2(final Drawable drawable) {
        ...
        if (mainActivity != null) {
            ...
            mainActivity.runOnUiThread(new Runnable() { // from class: com.habitrpg.android.habitica.ui.fragments.k
                @Override // java.lang.Runnable
                public final void run() {
                    AboutFragment$doTheThing$1.invoke$lambda$1(AboutFragment.this, drawable);
                }
            });
        }
    }
