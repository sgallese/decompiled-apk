...
public abstract class Hilt_ReportBottomSheetFragment extends com.google.android.material.bottomsheet.b implements ab.c {
    ...
    public Hilt_ReportBottomSheetFragment() {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ReportBottomSheetFragment_GeneratedInjector) generatedComponent()).injectReportBottomSheetFragment((ReportBottomSheetFragment) ab.e.a(this));
        }
    }
    ...
    Hilt_ReportBottomSheetFragment(int i10) {
        super(i10);
        this.componentManagerLock = new Object();
        this.injected = false;
    }
