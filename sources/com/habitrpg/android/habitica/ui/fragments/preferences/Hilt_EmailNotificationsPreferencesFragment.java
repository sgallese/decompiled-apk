...
public abstract class Hilt_EmailNotificationsPreferencesFragment extends BasePreferencesFragment implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((EmailNotificationsPreferencesFragment_GeneratedInjector) generatedComponent()).injectEmailNotificationsPreferencesFragment((EmailNotificationsPreferencesFragment) ab.e.a(this));
        }
    }
