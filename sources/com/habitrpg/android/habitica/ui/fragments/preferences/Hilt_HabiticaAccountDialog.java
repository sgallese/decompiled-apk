...
public abstract class Hilt_HabiticaAccountDialog extends com.google.android.material.bottomsheet.b implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((HabiticaAccountDialog_GeneratedInjector) generatedComponent()).injectHabiticaAccountDialog((HabiticaAccountDialog) ab.e.a(this));
        }
    }
    ...
    public Hilt_HabiticaAccountDialog(int i10) {
        super(i10);
        this.componentManagerLock = new Object();
        this.injected = false;
    }
