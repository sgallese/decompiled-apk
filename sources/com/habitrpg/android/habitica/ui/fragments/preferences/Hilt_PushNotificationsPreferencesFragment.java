...
public abstract class Hilt_PushNotificationsPreferencesFragment extends BasePreferencesFragment implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PushNotificationsPreferencesFragment_GeneratedInjector) generatedComponent()).injectPushNotificationsPreferencesFragment((PushNotificationsPreferencesFragment) ab.e.a(this));
        }
    }
