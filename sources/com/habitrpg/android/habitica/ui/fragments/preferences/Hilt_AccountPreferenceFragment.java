...
public abstract class Hilt_AccountPreferenceFragment extends BasePreferencesFragment implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AccountPreferenceFragment_GeneratedInjector) generatedComponent()).injectAccountPreferenceFragment((AccountPreferenceFragment) ab.e.a(this));
        }
    }
