...
public abstract class Hilt_PreferencesFragment extends BasePreferencesFragment implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PreferencesFragment_GeneratedInjector) generatedComponent()).injectPreferencesFragment((PreferencesFragment) ab.e.a(this));
        }
    }
