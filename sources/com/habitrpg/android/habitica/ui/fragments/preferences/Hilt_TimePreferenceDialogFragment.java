...
public abstract class Hilt_TimePreferenceDialogFragment extends androidx.preference.g implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TimePreferenceDialogFragment_GeneratedInjector) generatedComponent()).injectTimePreferenceDialogFragment((TimePreferenceDialogFragment) ab.e.a(this));
        }
    }
