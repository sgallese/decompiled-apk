...
public abstract class Hilt_AboutFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AboutFragment_GeneratedInjector) generatedComponent()).injectAboutFragment((AboutFragment) ab.e.a(this));
        }
    }
