...
public class AvatarCustomizationFragmentArgs implements k3.f {
    ...
    public static AvatarCustomizationFragmentArgs fromBundle(Bundle bundle) {
        ...
        if (bundle.containsKey(TaskFormActivity.TASK_TYPE_KEY)) {
            ...
            if (string != null) {
                avatarCustomizationFragmentArgs.arguments.put(TaskFormActivity.TASK_TYPE_KEY, string);
    ...
    public static AvatarCustomizationFragmentArgs fromSavedStateHandle(n0 n0Var) {
        AvatarCustomizationFragmentArgs avatarCustomizationFragmentArgs = new AvatarCustomizationFragmentArgs();
        if (n0Var.e(TaskFormActivity.TASK_TYPE_KEY)) {
            String str = (String) n0Var.f(TaskFormActivity.TASK_TYPE_KEY);
            if (str != null) {
                avatarCustomizationFragmentArgs.arguments.put(TaskFormActivity.TASK_TYPE_KEY, str);
                if (n0Var.e("category")) {
                    String str2 = (String) n0Var.f("category");
                    if (str2 != null) {
                        avatarCustomizationFragmentArgs.arguments.put("category", str2);
                        return avatarCustomizationFragmentArgs;
                    }
                    throw new IllegalArgumentException("Argument \"category\" is marked as non-null but was passed a null value.");
                }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.arguments.containsKey(TaskFormActivity.TASK_TYPE_KEY) != avatarCustomizationFragmentArgs.arguments.containsKey(TaskFormActivity.TASK_TYPE_KEY)) {
            return false;
        }
        ...
        if (getCategory() == null ? avatarCustomizationFragmentArgs.getCategory() == null : getCategory().equals(avatarCustomizationFragmentArgs.getCategory())) {
            return true;
        }
        return false;
    }
    ...
    public static final class Builder {
        ...
        public Builder(AvatarCustomizationFragmentArgs avatarCustomizationFragmentArgs) {
            ...
            hashMap.putAll(avatarCustomizationFragmentArgs.arguments);
        }
