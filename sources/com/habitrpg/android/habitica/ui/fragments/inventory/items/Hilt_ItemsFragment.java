...
public abstract class Hilt_ItemsFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ItemsFragment_GeneratedInjector) generatedComponent()).injectItemsFragment((ItemsFragment) ab.e.a(this));
        }
    }
