...
public abstract class Hilt_StableFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((StableFragment_GeneratedInjector) generatedComponent()).injectStableFragment((StableFragment) ab.e.a(this));
        }
    }
