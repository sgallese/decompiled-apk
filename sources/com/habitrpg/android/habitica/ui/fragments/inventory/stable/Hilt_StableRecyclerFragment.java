...
public abstract class Hilt_StableRecyclerFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((StableRecyclerFragment_GeneratedInjector) generatedComponent()).injectStableRecyclerFragment((StableRecyclerFragment) ab.e.a(this));
        }
    }
