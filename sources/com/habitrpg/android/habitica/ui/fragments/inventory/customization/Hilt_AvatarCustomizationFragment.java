...
public abstract class Hilt_AvatarCustomizationFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AvatarCustomizationFragment_GeneratedInjector) generatedComponent()).injectAvatarCustomizationFragment((AvatarCustomizationFragment) ab.e.a(this));
        }
    }
