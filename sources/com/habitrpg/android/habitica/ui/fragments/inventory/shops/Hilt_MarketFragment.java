...
public abstract class Hilt_MarketFragment extends ShopFragment implements c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((MarketFragment_GeneratedInjector) generatedComponent()).injectMarketFragment((MarketFragment) e.a(this));
        }
    }
