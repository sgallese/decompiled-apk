...
public abstract class Hilt_EquipmentDetailFragment<VB extends e4.a> extends BaseMainFragment<VB> implements c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((EquipmentDetailFragment_GeneratedInjector) generatedComponent()).injectEquipmentDetailFragment((EquipmentDetailFragment) e.a(this));
        }
    }
