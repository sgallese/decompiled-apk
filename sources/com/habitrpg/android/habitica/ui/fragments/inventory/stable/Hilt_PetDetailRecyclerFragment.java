...
public abstract class Hilt_PetDetailRecyclerFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PetDetailRecyclerFragment_GeneratedInjector) generatedComponent()).injectPetDetailRecyclerFragment((PetDetailRecyclerFragment) ab.e.a(this));
        }
    }
