...
public abstract class Hilt_TimeTravelersShopFragment extends ShopFragment implements c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TimeTravelersShopFragment_GeneratedInjector) generatedComponent()).injectTimeTravelersShopFragment((TimeTravelersShopFragment) e.a(this));
        }
    }
