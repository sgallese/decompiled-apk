...
public abstract class Hilt_MountDetailRecyclerFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((MountDetailRecyclerFragment_GeneratedInjector) generatedComponent()).injectMountDetailRecyclerFragment((MountDetailRecyclerFragment) ab.e.a(this));
        }
    }
