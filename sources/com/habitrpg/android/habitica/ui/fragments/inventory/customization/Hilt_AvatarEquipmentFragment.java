...
public abstract class Hilt_AvatarEquipmentFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AvatarEquipmentFragment_GeneratedInjector) generatedComponent()).injectAvatarEquipmentFragment((AvatarEquipmentFragment) ab.e.a(this));
        }
    }
