...
public final class StableRecyclerFragment$special$$inlined$viewModels$default$5 extends r implements pc.a<y0.b> {
    final /* synthetic */ dc.f $owner$delegate;
    final /* synthetic */ Fragment $this_viewModels;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StableRecyclerFragment$special$$inlined$viewModels$default$5(Fragment fragment, dc.f fVar) {
        super(0);
