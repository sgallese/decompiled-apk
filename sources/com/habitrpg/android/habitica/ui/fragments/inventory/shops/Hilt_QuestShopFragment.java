...
public abstract class Hilt_QuestShopFragment extends ShopFragment implements c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((QuestShopFragment_GeneratedInjector) generatedComponent()).injectQuestShopFragment((QuestShopFragment) e.a(this));
        }
    }
