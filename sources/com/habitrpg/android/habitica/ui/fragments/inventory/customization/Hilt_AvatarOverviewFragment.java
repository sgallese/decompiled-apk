...
public abstract class Hilt_AvatarOverviewFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AvatarOverviewFragment_GeneratedInjector) generatedComponent()).injectAvatarOverviewFragment((AvatarOverviewFragment) ab.e.a(this));
        }
    }
