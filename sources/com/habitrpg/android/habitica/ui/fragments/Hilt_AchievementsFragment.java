...
public abstract class Hilt_AchievementsFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AchievementsFragment_GeneratedInjector) generatedComponent()).injectAchievementsFragment((AchievementsFragment) ab.e.a(this));
        }
    }
