...
public abstract class Hilt_FAQDetailFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((FAQDetailFragment_GeneratedInjector) generatedComponent()).injectFAQDetailFragment((FAQDetailFragment) ab.e.a(this));
        }
    }
