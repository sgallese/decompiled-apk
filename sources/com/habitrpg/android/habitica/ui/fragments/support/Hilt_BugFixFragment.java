...
public abstract class Hilt_BugFixFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((BugFixFragment_GeneratedInjector) generatedComponent()).injectBugFixFragment((BugFixFragment) ab.e.a(this));
        }
    }
