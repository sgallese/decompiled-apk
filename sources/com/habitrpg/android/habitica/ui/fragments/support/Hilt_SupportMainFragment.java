...
public abstract class Hilt_SupportMainFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SupportMainFragment_GeneratedInjector) generatedComponent()).injectSupportMainFragment((SupportMainFragment) ab.e.a(this));
        }
    }
