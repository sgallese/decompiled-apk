...
public abstract class Hilt_FAQOverviewFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((FAQOverviewFragment_GeneratedInjector) generatedComponent()).injectFAQOverviewFragment((FAQOverviewFragment) ab.e.a(this));
        }
    }
