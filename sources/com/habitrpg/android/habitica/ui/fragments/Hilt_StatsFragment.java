...
public abstract class Hilt_StatsFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((StatsFragment_GeneratedInjector) generatedComponent()).injectStatsFragment((StatsFragment) ab.e.a(this));
        }
    }
