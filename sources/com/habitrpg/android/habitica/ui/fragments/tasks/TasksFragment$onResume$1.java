...
@kotlin.coroutines.jvm.internal.f(c = "com.habitrpg.android.habitica.ui.fragments.tasks.TasksFragment$onResume$1", f = "TasksFragment.kt", l = {128}, m = "invokeSuspend")
/* loaded from: classes4.dex */
final class TasksFragment$onResume$1 extends l implements p<k0, Continuation<? super w>, Object> {
    Object L$0;
    int label;
    ...
    public TasksFragment$onResume$1(TasksFragment tasksFragment, Continuation<? super TasksFragment$onResume$1> continuation) {
    ...
    public final Continuation<w> create(Object obj, Continuation<?> continuation) {
        return new TasksFragment$onResume$1(this.this$0, continuation);
    }

    @Override // pc.p
    public final Object invoke(k0 k0Var, Continuation<? super w> continuation) {
        return ((TasksFragment$onResume$1) create(k0Var, continuation)).invokeSuspend(w.f13270a);
    }
