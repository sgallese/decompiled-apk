...
public abstract class Hilt_TaskRecyclerViewFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TaskRecyclerViewFragment_GeneratedInjector) generatedComponent()).injectTaskRecyclerViewFragment((TaskRecyclerViewFragment) ab.e.a(this));
        }
    }
