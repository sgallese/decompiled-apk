...
public abstract class Hilt_SkillTasksRecyclerViewFragment<VB extends e4.a> extends BaseFragment<VB> implements c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SkillTasksRecyclerViewFragment_GeneratedInjector) generatedComponent()).injectSkillTasksRecyclerViewFragment((SkillTasksRecyclerViewFragment) e.a(this));
        }
    }
