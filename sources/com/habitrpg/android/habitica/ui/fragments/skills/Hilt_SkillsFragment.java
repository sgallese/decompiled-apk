...
public abstract class Hilt_SkillsFragment<VB extends e4.a> extends BaseMainFragment<VB> implements c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SkillsFragment_GeneratedInjector) generatedComponent()).injectSkillsFragment((SkillsFragment) e.a(this));
        }
    }
