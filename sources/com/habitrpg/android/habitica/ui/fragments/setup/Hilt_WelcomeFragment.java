...
public abstract class Hilt_WelcomeFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((WelcomeFragment_GeneratedInjector) generatedComponent()).injectWelcomeFragment((WelcomeFragment) ab.e.a(this));
        }
    }
