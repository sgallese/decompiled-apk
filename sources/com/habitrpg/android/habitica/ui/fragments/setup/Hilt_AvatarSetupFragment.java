...
public abstract class Hilt_AvatarSetupFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AvatarSetupFragment_GeneratedInjector) generatedComponent()).injectAvatarSetupFragment((AvatarSetupFragment) ab.e.a(this));
        }
    }
