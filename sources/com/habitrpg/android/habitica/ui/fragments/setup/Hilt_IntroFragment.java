...
public abstract class Hilt_IntroFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((IntroFragment_GeneratedInjector) generatedComponent()).injectIntroFragment((IntroFragment) ab.e.a(this));
        }
    }
