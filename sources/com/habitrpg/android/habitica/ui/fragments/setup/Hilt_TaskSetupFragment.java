...
public abstract class Hilt_TaskSetupFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((TaskSetupFragment_GeneratedInjector) generatedComponent()).injectTaskSetupFragment((TaskSetupFragment) ab.e.a(this));
        }
    }
