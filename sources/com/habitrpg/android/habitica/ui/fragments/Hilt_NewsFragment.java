...
public abstract class Hilt_NewsFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((NewsFragment_GeneratedInjector) generatedComponent()).injectNewsFragment((NewsFragment) ab.e.a(this));
        }
    }
