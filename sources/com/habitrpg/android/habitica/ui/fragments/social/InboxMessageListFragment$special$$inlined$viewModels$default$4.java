...
public final class InboxMessageListFragment$special$$inlined$viewModels$default$4 extends r implements pc.a<j3.a> {
    final /* synthetic */ pc.a $extrasProducer;
    final /* synthetic */ dc.f $owner$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InboxMessageListFragment$special$$inlined$viewModels$default$4(pc.a aVar, dc.f fVar) {
        super(0);
