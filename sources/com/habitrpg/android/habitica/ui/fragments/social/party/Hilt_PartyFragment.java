...
public abstract class Hilt_PartyFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PartyFragment_GeneratedInjector) generatedComponent()).injectPartyFragment((PartyFragment) ab.e.a(this));
        }
    }
