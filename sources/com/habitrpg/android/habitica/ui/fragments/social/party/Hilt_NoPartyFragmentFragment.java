...
public abstract class Hilt_NoPartyFragmentFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((NoPartyFragmentFragment_GeneratedInjector) generatedComponent()).injectNoPartyFragmentFragment((NoPartyFragmentFragment) ab.e.a(this));
        }
    }
