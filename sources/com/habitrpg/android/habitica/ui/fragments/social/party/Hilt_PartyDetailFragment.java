...
public abstract class Hilt_PartyDetailFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PartyDetailFragment_GeneratedInjector) generatedComponent()).injectPartyDetailFragment((PartyDetailFragment) ab.e.a(this));
        }
    }
