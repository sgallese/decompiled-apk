...
public final class PartyInvitePagerFragment$special$$inlined$viewModels$default$5 extends qc.r implements pc.a<y0.b> {
    final /* synthetic */ dc.f $owner$delegate;
    final /* synthetic */ Fragment $this_viewModels;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PartyInvitePagerFragment$special$$inlined$viewModels$default$5(Fragment fragment, dc.f fVar) {
        super(0);
