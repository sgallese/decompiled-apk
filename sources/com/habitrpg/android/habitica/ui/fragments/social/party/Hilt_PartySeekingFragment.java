...
public abstract class Hilt_PartySeekingFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PartySeekingFragment_GeneratedInjector) generatedComponent()).injectPartySeekingFragment((PartySeekingFragment) ab.e.a(this));
        }
    }
