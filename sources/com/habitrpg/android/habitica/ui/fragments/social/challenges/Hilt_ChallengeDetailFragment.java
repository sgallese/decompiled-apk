...
public abstract class Hilt_ChallengeDetailFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ChallengeDetailFragment_GeneratedInjector) generatedComponent()).injectChallengeDetailFragment((ChallengeDetailFragment) ab.e.a(this));
        }
    }
