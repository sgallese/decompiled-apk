...
public abstract class Hilt_InboxOverviewFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((InboxOverviewFragment_GeneratedInjector) generatedComponent()).injectInboxOverviewFragment((InboxOverviewFragment) ab.e.a(this));
        }
    }
