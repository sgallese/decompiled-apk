...
public abstract class Hilt_ChatFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ChatFragment_GeneratedInjector) generatedComponent()).injectChatFragment((ChatFragment) ab.e.a(this));
        }
    }
