...
public final class GuildDetailFragment$special$$inlined$viewModels$default$4 extends r implements pc.a<y0.b> {
    final /* synthetic */ dc.f $owner$delegate;
    final /* synthetic */ Fragment $this_viewModels;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuildDetailFragment$special$$inlined$viewModels$default$4(Fragment fragment, dc.f fVar) {
        super(0);
