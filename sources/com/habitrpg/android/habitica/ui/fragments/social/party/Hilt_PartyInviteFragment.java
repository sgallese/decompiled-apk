...
public abstract class Hilt_PartyInviteFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PartyInviteFragment_GeneratedInjector) generatedComponent()).injectPartyInviteFragment((PartyInviteFragment) ab.e.a(this));
        }
    }
