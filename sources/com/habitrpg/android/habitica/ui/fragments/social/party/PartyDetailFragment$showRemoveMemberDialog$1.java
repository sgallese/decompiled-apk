...
public final class PartyDetailFragment$showRemoveMemberDialog$1 extends qc.r implements pc.p<HabiticaAlertDialog, Integer, w> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: PartyDetailFragment.kt */
    @kotlin.coroutines.jvm.internal.f(c = "com.habitrpg.android.habitica.ui.fragments.social.party.PartyDetailFragment$showRemoveMemberDialog$1$1", f = "PartyDetailFragment.kt", l = {431}, m = "invokeSuspend")
    /* renamed from: com.habitrpg.android.habitica.ui.fragments.social.party.PartyDetailFragment$showRemoveMemberDialog$1$1  reason: invalid class name */
    /* loaded from: classes4.dex */
    public static final class AnonymousClass1 extends kotlin.coroutines.jvm.internal.l implements pc.p<k0, Continuation<? super w>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                this.label = 1;
                if (socialRepository.removeMemberFromGroup(groupID, str, this) == d10) {
                    return d10;
                }
            }
            ...
            if (mainActivity != null && (snackbarContainer = mainActivity.getSnackbarContainer()) != null) {
                ...
                j0 j0Var = j0.f21683a;
                String string = partyDetailFragment.getString(R.string.removed_member);
                ...
                FragmentPartyDetailBinding binding = partyDetailFragment.getBinding();
                if (binding != null && (linearLayout = binding.membersWrapper) != null && (findViewWithTag = linearLayout.findViewWithTag(str3)) != null) {
                    qc.q.f(findViewWithTag);
                    FragmentPartyDetailBinding binding2 = partyDetailFragment.getBinding();
                    if (binding2 != null && (linearLayout2 = binding2.membersWrapper) != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PartyDetailFragment$showRemoveMemberDialog$1(PartyDetailFragment partyDetailFragment, String str, String str2) {
        super(2);
        this.this$0 = partyDetailFragment;
        this.$userID = str;
        this.$displayName = str2;
