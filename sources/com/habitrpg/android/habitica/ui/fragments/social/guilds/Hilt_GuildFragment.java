...
public abstract class Hilt_GuildFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((GuildFragment_GeneratedInjector) generatedComponent()).injectGuildFragment((GuildFragment) ab.e.a(this));
        }
    }
