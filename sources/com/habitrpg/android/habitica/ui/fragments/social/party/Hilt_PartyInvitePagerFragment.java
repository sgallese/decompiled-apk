...
public abstract class Hilt_PartyInvitePagerFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PartyInvitePagerFragment_GeneratedInjector) generatedComponent()).injectPartyInvitePagerFragment((PartyInvitePagerFragment) ab.e.a(this));
        }
    }
