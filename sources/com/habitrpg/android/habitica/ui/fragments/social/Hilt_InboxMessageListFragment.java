...
public abstract class Hilt_InboxMessageListFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((InboxMessageListFragment_GeneratedInjector) generatedComponent()).injectInboxMessageListFragment((InboxMessageListFragment) ab.e.a(this));
        }
    }
