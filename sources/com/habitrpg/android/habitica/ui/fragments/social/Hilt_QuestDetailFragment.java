...
public abstract class Hilt_QuestDetailFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((QuestDetailFragment_GeneratedInjector) generatedComponent()).injectQuestDetailFragment((QuestDetailFragment) ab.e.a(this));
        }
    }
