...
public abstract class Hilt_GuildDetailFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((GuildDetailFragment_GeneratedInjector) generatedComponent()).injectGuildDetailFragment((GuildDetailFragment) ab.e.a(this));
        }
    }
