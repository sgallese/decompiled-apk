...
public abstract class Hilt_ChallengesOverviewFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ChallengesOverviewFragment_GeneratedInjector) generatedComponent()).injectChallengesOverviewFragment((ChallengesOverviewFragment) ab.e.a(this));
        }
    }
