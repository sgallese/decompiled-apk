...
public abstract class Hilt_PromoWebFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PromoWebFragment_GeneratedInjector) generatedComponent()).injectPromoWebFragment((PromoWebFragment) ab.e.a(this));
        }
    }
