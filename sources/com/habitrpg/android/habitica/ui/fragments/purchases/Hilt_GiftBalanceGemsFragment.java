...
public abstract class Hilt_GiftBalanceGemsFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((GiftBalanceGemsFragment_GeneratedInjector) generatedComponent()).injectGiftBalanceGemsFragment((GiftBalanceGemsFragment) ab.e.a(this));
        }
    }
