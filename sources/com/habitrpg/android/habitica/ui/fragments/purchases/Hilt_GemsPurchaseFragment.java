...
public abstract class Hilt_GemsPurchaseFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((GemsPurchaseFragment_GeneratedInjector) generatedComponent()).injectGemsPurchaseFragment((GemsPurchaseFragment) ab.e.a(this));
        }
    }
