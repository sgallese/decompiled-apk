...
public abstract class Hilt_SubscriptionBottomSheetFragment extends com.google.android.material.bottomsheet.b implements ab.c {
    ...
    public Hilt_SubscriptionBottomSheetFragment() {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SubscriptionBottomSheetFragment_GeneratedInjector) generatedComponent()).injectSubscriptionBottomSheetFragment((SubscriptionBottomSheetFragment) ab.e.a(this));
        }
    }
    ...
    Hilt_SubscriptionBottomSheetFragment(int i10) {
        super(i10);
        this.componentManagerLock = new Object();
        this.injected = false;
    }
