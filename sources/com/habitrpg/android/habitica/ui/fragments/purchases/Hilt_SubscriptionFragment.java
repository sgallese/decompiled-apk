...
public abstract class Hilt_SubscriptionFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((SubscriptionFragment_GeneratedInjector) generatedComponent()).injectSubscriptionFragment((SubscriptionFragment) ab.e.a(this));
        }
    }
