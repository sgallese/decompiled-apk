...
public abstract class Hilt_GiftPurchaseGemsFragment<VB extends e4.a> extends BaseFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((GiftPurchaseGemsFragment_GeneratedInjector) generatedComponent()).injectGiftPurchaseGemsFragment((GiftPurchaseGemsFragment) ab.e.a(this));
        }
    }
