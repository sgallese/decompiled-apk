...
public abstract class Hilt_PromoInfoFragment<VB extends e4.a> extends BaseMainFragment<VB> implements ab.c {
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PromoInfoFragment_GeneratedInjector) generatedComponent()).injectPromoInfoFragment((PromoInfoFragment) ab.e.a(this));
        }
    }
