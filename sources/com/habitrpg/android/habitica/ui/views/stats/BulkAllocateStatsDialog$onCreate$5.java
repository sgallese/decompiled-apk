...
final class BulkAllocateStatsDialog$onCreate$5 extends r implements l<Integer, w> {
    final /* synthetic */ BulkAllocateStatsDialog this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BulkAllocateStatsDialog$onCreate$5(BulkAllocateStatsDialog bulkAllocateStatsDialog) {
        super(1);
    ...
    public final void invoke(int i10) {
        ...
        StatsSliderView statsSliderView = dialogBulkAllocateBinding.perceptionSliderView;
        q.h(statsSliderView, "perceptionSliderView");
