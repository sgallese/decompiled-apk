...
final class ComposableSingletons$LoadingButtonKt$lambda8$1 extends r implements q<a0, j0.l, Integer, w> {
    ...
    public final void invoke(a0 a0Var, j0.l lVar, int i10) {
        ...
        if (n.K()) {
            n.V(-739033476, i10, -1, "com.habitrpg.android.habitica.ui.views.ComposableSingletons$LoadingButtonKt.lambda-8.<anonymous> (LoadingButton.kt:263)");
        }
