...
final class AchievementDialog$configure$2 extends r implements p<HabiticaAlertDialog, Integer, w> {
    public static final AchievementDialog$configure$2 INSTANCE = new AchievementDialog$configure$2();

    AchievementDialog$configure$2() {
        super(2);
    }
