...
public final class ClassTextKt$ClassText$3 extends r implements p<j0.l, Integer, w> {
    ...
    public ClassTextKt$ClassText$3(String str, boolean z10, long j10, androidx.compose.ui.e eVar, j2.h hVar, int i10, int i11) {
        super(2);
        this.$className = str;
        this.$hasClass = z10;
        this.$fontSize = j10;
