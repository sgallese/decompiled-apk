...
final class MountBottomSheetKt$MountBottomSheet$1$1$position$2$1 extends r implements l<o0.b<Float>, w> {
    ...
    public MountBottomSheetKt$MountBottomSheet$1$1$position$2$1(float f10, float f11, float f12) {
        super(1);
