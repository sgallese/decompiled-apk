...
public final class GiftSubscriptionActivity$onCreate$$inlined$navArgs$2 extends qc.r implements pc.a<Bundle> {
    final /* synthetic */ Activity $this_navArgs;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GiftSubscriptionActivity$onCreate$$inlined$navArgs$2(Activity activity) {
        super(0);
