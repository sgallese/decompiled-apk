...
public final class GiftGemsActivity$onCreate$$inlined$navArgs$1 extends qc.r implements pc.a<Bundle> {
    final /* synthetic */ Activity $this_navArgs;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GiftGemsActivity$onCreate$$inlined$navArgs$1(Activity activity) {
        super(0);
