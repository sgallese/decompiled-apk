...
public final class ChallengeTasksRecyclerViewAdapter$onCreateViewHolder$viewHolder$7 extends r implements l<Task, w> {
    final /* synthetic */ ChallengeTasksRecyclerViewAdapter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChallengeTasksRecyclerViewAdapter$onCreateViewHolder$viewHolder$7(ChallengeTasksRecyclerViewAdapter challengeTasksRecyclerViewAdapter) {
        super(1);
