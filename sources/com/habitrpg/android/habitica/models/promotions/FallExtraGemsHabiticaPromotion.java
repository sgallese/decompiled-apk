...
/* compiled from: FallExtraGemsHabiticaPromotion.kt */
/* loaded from: classes4.dex */
public final class FallExtraGemsHabiticaPromotion extends HabiticaPromotion {
    public static final int $stable = 8;
    private final Date endDate;
    private final Date startDate;

    public FallExtraGemsHabiticaPromotion(Date date, Date date2) {
        this.startDate = date == null ? DateUtils.Companion.createDate(2020, 8, 22) : date;
        this.endDate = date2 == null ? DateUtils.Companion.createDate(2020, 8, 30) : date2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void configurePromoMenuView$lambda$0(FallExtraGemsHabiticaPromotion fallExtraGemsHabiticaPromotion, Context context, View view) {
        q.i(fallExtraGemsHabiticaPromotion, "this$0");
        q.f(context);
        fallExtraGemsHabiticaPromotion.menuOnNavigation(context);
    }
    ...
    public Drawable buttonDrawable(Context context) {
        q.i(context, "context");
        Drawable e10 = a.e(context, R.drawable.fall_promo_button_bg);
        if (e10 == null) {
        ...
        if (i10 != 4) {
            if (i10 != 21) {
                if (i10 != 42) {
                    ...
                    purchaseGemViewBinding.gemImage.setImageResource(R.drawable.fall_gems_84);
                    return;
                }
                purchaseGemViewBinding.gemAmount.setText("60");
                purchaseGemViewBinding.gemImage.setImageResource(R.drawable.fall_gems_42);
                return;
            }
            purchaseGemViewBinding.gemAmount.setText("30");
            purchaseGemViewBinding.gemImage.setImageResource(R.drawable.fall_gems_21);
            return;
        }
        purchaseGemViewBinding.gemAmount.setText("5");
        purchaseGemViewBinding.gemImage.setImageResource(R.drawable.fall_gems_4);
    }
    ...
    public void configureInfoFragment(PromoInfoFragment promoInfoFragment) {
        ...
        if (binding2 != null && (imageView3 = binding2.promoBannerLeftImage) != null) {
            imageView3.setImageDrawable(a.e(context, R.drawable.fall_promo_info_left));
        }
        ...
        if (binding3 != null && (imageView2 = binding3.promoBannerRightImage) != null) {
            imageView2.setImageDrawable(a.e(context, R.drawable.fall_promo_info_right));
        }
        ...
        if (binding4 != null && (imageView = binding4.promoBannerTitleImage) != null) {
            imageView.setImageDrawable(a.e(context, R.drawable.fall_promo_title));
        }
        ...
        if (binding6 != null && (textView10 = binding6.promoBannerDurationView) != null) {
            textView10.setTextColor(Color.parseColor("#FEE2B6"));
        }
        ...
        if (binding14 != null && (textView4 = binding14.promptButton) != null) {
            textView4.setOnClickListener(new View.OnClickListener() { // from class: ka.b
                ...
                public final void onClick(View view) {
                    FallExtraGemsHabiticaPromotion.configureInfoFragment$lambda$1(view);
                }
            });
        }
        ...
        if (textView3 != null) {
            textView3.setText(context.getString(R.string.fall_promo_info_instructions, simpleDateFormat.format(getStartDate()), simpleDateFormat.format(getEndDate())));
        }
    ...
    public void configurePromoMenuView(PromoMenuView promoMenuView) {
        ...
        promoMenuView.setTitleImage(a.e(context, R.drawable.fall_promo_title));
        promoMenuView.setTitleText(null);
        promoMenuView.setSubtitleImage(a.e(context, R.drawable.fall_promo_menu_description));
        promoMenuView.setSubtitleText(null);
        promoMenuView.setDecoration(a.e(context, R.drawable.fall_promo_menu_left), a.e(context, R.drawable.fall_promo_menu_right));
        ...
        promoMenuView.getBinding().button.setOnClickListener(new View.OnClickListener() { // from class: ka.a
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                FallExtraGemsHabiticaPromotion.configurePromoMenuView$lambda$0(FallExtraGemsHabiticaPromotion.this, context, view);
            }
        });
    }
    ...
    public Drawable pillBackgroundDrawable(Context context) {
        q.i(context, "context");
        Drawable e10 = a.e(context, R.drawable.fall_promo_pill_bg);
        if (e10 == null) {
            return new ShapeDrawable();
        }
        return e10;
    ...
    public void configurePurchaseBanner(FragmentGemPurchaseBinding fragmentGemPurchaseBinding) {
        ...
        q.f(context);
        relativeLayout.setBackground(promoBackgroundDrawable(context));
        fragmentGemPurchaseBinding.promoBannerLeftImage.setImageDrawable(a.e(context, R.drawable.fall_promo_banner_left));
        fragmentGemPurchaseBinding.promoBannerRightImage.setImageDrawable(a.e(context, R.drawable.fall_promo_banner_right));
        fragmentGemPurchaseBinding.promoBannerTitleImage.setImageDrawable(a.e(context, R.drawable.fall_promo_title));
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("MMM d", Locale.getDefault());
        ...
        fragmentGemPurchaseBinding.promoBannerDurationView.setTextColor(Color.parseColor("#FEE2B6"));
    }
}
