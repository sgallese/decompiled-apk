...
public final class Task$markdownNotes$1 extends r implements l<Spanned, w> {
    ...
    public Task$markdownNotes$1(Task task, l<? super CharSequence, w> lVar) {
        super(1);
        this.this$0 = task;
        this.$callback = lVar;
    }
    ...
    public final void invoke2(Spanned spanned) {
        ...
        this.this$0.setParsedNotes(spanned);
