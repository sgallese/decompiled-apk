...
@kotlin.coroutines.jvm.internal.f(c = "com.habitrpg.android.habitica.helpers.PurchaseHandler$handle$3", f = "PurchaseHandler.kt", l = {318, 321}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class PurchaseHandler$handle$3 extends l implements p<k0, Continuation<? super w>, Object> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: PurchaseHandler.kt */
    @kotlin.coroutines.jvm.internal.f(c = "com.habitrpg.android.habitica.helpers.PurchaseHandler$handle$3$1", f = "PurchaseHandler.kt", l = {322}, m = "invokeSuspend")
    /* renamed from: com.habitrpg.android.habitica.helpers.PurchaseHandler$handle$3$1  reason: invalid class name */
    /* loaded from: classes4.dex */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PurchaseHandler$handle$3(PurchaseHandler purchaseHandler, PurchaseValidationRequest purchaseValidationRequest, Purchase purchase, String str, Continuation<? super PurchaseHandler$handle$3> continuation) {
        super(2, continuation);
        this.this$0 = purchaseHandler;
    ...
    @Override // kotlin.coroutines.jvm.internal.a
    public final Continuation<w> create(Object obj, Continuation<?> continuation) {
        return new PurchaseHandler$handle$3(this.this$0, this.$validationRequest, this.$purchase, this.$sku, continuation);
    }

    @Override // pc.p
    public final Object invoke(k0 k0Var, Continuation<? super w> continuation) {
        return ((PurchaseHandler$handle$3) create(k0Var, continuation)).invokeSuspend(w.f13270a);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r8) {
        ...
        L39:
            ...
            com.habitrpg.android.habitica.helpers.PurchaseHandler$handle$3$1 r4 = new com.habitrpg.android.habitica.helpers.PurchaseHandler$handle$3$1     // Catch: java.lang.Throwable -> L23
        ...
        L79:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.habitrpg.android.habitica.helpers.PurchaseHandler$handle$3.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
