...
public final class GuildInviteLocalNotification extends HabiticaLocalNotification {
    public static final int $stable = 0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuildInviteLocalNotification(Context context, String str) {
        super(context, str);
        q.i(context, "context");
    }
    ...
    public void setNotificationActions(int i10, Map<String, String> map) {
        ...
        getNotificationBuilder().a(0, "Accept", PendingIntent.getBroadcast(context, i11, intent, PendingIntentExtensionsKt.withImmutableFlag(134217728)));
        ...
        getNotificationBuilder().a(0, "Reject", PendingIntent.getBroadcast(context2, i12 + 1, intent2, PendingIntentExtensionsKt.withImmutableFlag(134217728)));
    }
}
