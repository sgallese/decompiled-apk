...
final class PurchaseHandler$displayConfirmationDialog$2$1$2 extends r implements p<HabiticaAlertDialog, Integer, w> {
    final /* synthetic */ BaseActivity $activity;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PurchaseHandler$displayConfirmationDialog$2$1$2(BaseActivity baseActivity) {
        super(2);
