...
@f(c = "com.habitrpg.android.habitica.data.implementation.ApiClientImpl$markTaskNeedsWork$2", f = "ApiClientImpl.kt", l = {659}, m = "invokeSuspend")
/* loaded from: classes4.dex */
final class ApiClientImpl$markTaskNeedsWork$2 extends l implements pc.l<Continuation<? super HabitResponse<Task>>, Object> {
    ...
    public final Object invoke(Continuation<? super HabitResponse<Task>> continuation) {
        return ((ApiClientImpl$markTaskNeedsWork$2) create(continuation)).invokeSuspend(w.f13270a);
    }
}
