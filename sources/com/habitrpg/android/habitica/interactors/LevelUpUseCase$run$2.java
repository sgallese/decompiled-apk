...
public final class LevelUpUseCase$run$2 extends r implements p<HabiticaAlertDialog, Integer, w> {
    final /* synthetic */ LevelUpUseCase.RequestValues $requestValues;
    final /* synthetic */ LevelUpUseCase this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: LevelUpUseCase.kt */
    @f(c = "com.habitrpg.android.habitica.interactors.LevelUpUseCase$run$2$1", f = "LevelUpUseCase.kt", l = {40}, m = "invokeSuspend")
    /* renamed from: com.habitrpg.android.habitica.interactors.LevelUpUseCase$run$2$1  reason: invalid class name */
    /* loaded from: classes4.dex */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LevelUpUseCase$run$2(LevelUpUseCase levelUpUseCase, LevelUpUseCase.RequestValues requestValues) {
        super(2);
        this.this$0 = levelUpUseCase;
        this.$requestValues = requestValues;
    }
