...
public class h {
    ...
    private final androidx.collection.g<String, i> f25423a = new androidx.collection.g<>();

    /* renamed from: b  reason: collision with root package name */
    private final androidx.collection.g<String, PropertyValuesHolder[]> f25424b = new androidx.collection.g<>();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f25423a.equals(((h) obj).f25423a);
    }
    ...
    public void h(String str, PropertyValuesHolder[] propertyValuesHolderArr) {
        this.f25424b.put(str, propertyValuesHolderArr);
    }
    ...
    public void i(String str, i iVar) {
        this.f25423a.put(str, iVar);
    }

    public String toString() {
        return '\n' + getClass().getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.f25423a + "}\n";
    }
}
