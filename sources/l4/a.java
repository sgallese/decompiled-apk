...
public class a extends c<Boolean> {
    ...
    private static final String f19525i = l.f("BatteryChrgTracker");
    ...
    */
    public void h(android.content.Context r6, android.content.Intent r7) {
        ...
        L7:
            ...
            java.lang.String r0 = l4.a.f19525i
            r1 = 1
        ...
        L6c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: l4.a.h(android.content.Context, android.content.Intent):void");
    }
    ...
    public Boolean b() {
        ...
        if (registerReceiver == null) {
            l.c().b(f19525i, "getInitialState - null intent received", new Throwable[0]);
            return null;
        }
