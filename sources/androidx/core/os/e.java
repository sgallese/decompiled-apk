...
public final class e {
    public static final Bundle a(dc.l<String, ? extends Object>... lVarArr) {
        Bundle bundle = new Bundle(lVarArr.length);
        for (dc.l<String, ? extends Object> lVar : lVarArr) {
            String a10 = lVar.a();
            Object b10 = lVar.b();
            if (b10 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    qc.q.g(b10, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(a10, (Parcelable[]) b10);
                } else if (String.class.isAssignableFrom(componentType)) {
                    qc.q.g(b10, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(a10, (String[]) b10);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    qc.q.g(b10, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
