...
public class c0 {
    ...
    public static class a implements Executor {
        ...
        final Queue<Runnable> f774m = new ArrayDeque();

        /* renamed from: p  reason: collision with root package name */
        final Executor f775p;
        ...
        protected void c() {
            synchronized (this.f773f) {
                Runnable poll = this.f774m.poll();
                this.f776q = poll;
                if (poll != null) {
                    this.f775p.execute(poll);
                }
            }
        }
        ...
        public void execute(final Runnable runnable) {
            synchronized (this.f773f) {
                this.f774m.add(new Runnable() { // from class: androidx.appcompat.app.b0
                    @Override // java.lang.Runnable
                    public final void run() {
                        c0.a.this.b(runnable);
                    }
                });
                if (this.f776q == null) {
                    c();
    ...
    */
    public static java.lang.String b(android.content.Context r9) {
        ...
        L77:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.c0.b(android.content.Context):java.lang.String");
    }
