...
public final class Response<T> {
    ...
    public static <T> Response<T> success(T t10) {
        return success(t10, new Response.Builder().code(m.e.DEFAULT_DRAG_ANIMATION_DURATION).message("OK").protocol(Protocol.HTTP_1_1).request(new Request.Builder().url("http://localhost/").build()).build());
    }
    ...
    public static <T> Response<T> success(T t10, Headers headers) {
        ...
        return success(t10, new Response.Builder().code(m.e.DEFAULT_DRAG_ANIMATION_DURATION).message("OK").protocol(Protocol.HTTP_1_1).headers(headers).request(new Request.Builder().url("http://localhost/").build()).build());
    }
