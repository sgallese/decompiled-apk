...
public final class j {
    ...
    private static final Map<Class<?>, Class<?>> f16316a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map<Class<?>, Class<?>> f16317b;
    ...
    static {
        ...
        f16316a = Collections.unmodifiableMap(hashMap);
        f16317b = Collections.unmodifiableMap(hashMap2);
    }
    ...
    public static boolean b(Type type) {
        return f16316a.containsKey(type);
    }
}
